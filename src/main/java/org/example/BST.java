...
public class BST<T extends Comparable<? super T>>  {
    ...
    public boolean add(T data) throws IllegalArgumentException {
        ...
        return add(new BSTNode<T>(data), root);
    }
    ...
    private boolean add(BSTNode<T> node, BSTNode<T> root) {
    ...
    public T remove(T data) throws IllegalArgumentException,
        ...
        if (data == null) {
            ...
            throw new FailedRemoveException("Node containing {" + data
                    + "} could not be found");
        }
     ...
     */
    private T remove(T data, BSTNode<T> root) throws FailedRemoveException {
    ...
    public boolean contains(T data) throws IllegalArgumentException,
        ...
        try {
            get(data);
        } catch (FailedRemoveException exception) {
            return false;
        }
        return true;
    }
